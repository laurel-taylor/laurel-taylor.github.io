// Source: https://byjus.com/english/5-letter-words/
export const dayLibrary = new Set([
  'crime', 'shelf', 'aside', 'serve', 'grace', 'young', 'issue', 'booth', 'sheet', 'rival',
  'brand', 'dealt', 'sleep', 'sound', 'build', 'laser', 'china', 'chase', 'would', 'fresh',
  'arise', 'ratio', 'while', 'ideal', 'arena', 'ahead', 'trade', 'fruit', 'giant', 'which',
  'every', 'begin', 'teeth', 'force', 'entry', 'taste', 'false', 'glass', 'never', 'angle',
  'tired', 'light', 'frame', 'mayor', 'boost', 'route', 'truck', 'power', 'sight', 'harry',
  'grass', 'clear', 'avoid', 'forth', 'wrote', 'valid', 'lease', 'forty', 'fraud', 'media',
  'throw', 'civil', 'topic', 'chest', 'lucky', 'chair', 'bench', 'angry', 'sense', 'crash',
  'video', 'great', 'nurse', 'guard', 'adopt', 'noted', 'under', 'limit', 'title', 'depth',
  'human', 'apart', 'south', 'minor', 'royal', 'treat', 'baker', 'guess', 'level', 'adult',
  'month', 'horse', 'phone', 'cable', 'storm', 'sport', 'stand', 'layer', 'mixed', 'exist',
  'shift', 'label', 'worst', 'billy', 'brown', 'twice', 'equal', 'rapid', 'party', 'exact',
  'total', 'shown', 'still', 'whole', 'worry', 'match', 'alive', 'proud', 'smith', 'focus',
  'guest', 'heart', 'photo', 'house', 'broad', 'going', 'drive', 'major', 'those', 'watch',
  'round', 'learn', 'badly', 'after', 'truly', 'waste', 'plain', 'shall', 'stuck', 'grand',
  'money', 'calif', 'death', 'basis', 'solve', 'beach', 'whose', 'today', 'shoot', 'block',
  'smart', 'third', 'sweet', 'fiber', 'magic', 'speak', 'thing', 'taken', 'urban', 'green',
  'bases', 'chief', 'proof', 'final', 'empty', 'happy', 'drove', 'lunch', 'model', 'water',
  'radio', 'since', 'times', 'brain', 'brief', 'scene', 'stock', 'agent', 'track', 'stage',
  'bound', 'error', 'allow', 'alter', 'lower', 'scope', 'pound', 'range', 'clean', 'sixty',
  'blind', 'train', 'could', 'enemy', 'image', 'close', 'ocean', 'grant', 'tight', 'index',
  'board', 'cream', 'slide', 'spare', 'alarm', 'drama', 'shirt', 'truth', 'prior', 'audit',
  'shell', 'gross', 'aware', 'again', 'laugh', 'chain', 'moral', 'scale', 'voice', 'found',
  'daily', 'legal', 'frank', 'judge', 'worse', 'chart', 'local', 'panel', 'abuse', 'threw',
  'fight', 'alone', 'cycle', 'night', 'value', 'cross', 'crown', 'carry', 'count', 'reach',
  'might', 'large', 'built', 'pitch', 'point', 'spent', 'peace', 'prize', 'fifth', 'cheap',
  'award', 'split', 'stood', 'flash', 'music', 'above', 'dated', 'below', 'agree', 'union',
  'about', 'sorry', 'alert', 'fifty', 'joint', 'dance', 'cause', 'click', 'motor', 'doing',
  'shock', 'write', 'early', 'wound', 'buyer', 'novel', 'being', 'loose', 'basic', 'floor',
  'grown', 'ready', 'pride', 'movie', 'crowd', 'taxes', 'phase', 'paper', 'steam', 'pilot',
  'trend', 'roman', 'begun', 'actor', 'white', 'order', 'other', 'tower', 'forum', 'tries',
  'catch', 'raise', 'start', 'often', 'style', 'teach', 'spend', 'virus', 'price', 'among',
  'occur', 'theme', 'array', 'broke', 'steel', 'sugar', 'field', 'enjoy', 'sized', 'their',
  'think', 'fleet', 'eight', 'dozen', 'visit', 'dying', 'earth', 'small', 'curve',
  'woman', 'given', 'coast', 'short', 'input', 'claim', 'argue', 'trial', 'child', 'smoke',
  'prove', 'break', 'world', 'quick', 'seven', 'wheel', 'state', 'inner', 'plane', 'extra',
  'shape', 'grade', 'staff', 'stick', 'until', 'leave', 'rural', 'audio', 'guide', 'asset',
  'black', 'north', 'cover', 'worth', 'solid', 'craft', 'drill', 'along', 'queen', 'yield',
  'fully', 'minus', 'plate', 'draft', 'press', 'group', 'delay', 'breed', 'quite', 'doubt',
  'fixed', 'plant', 'where', 'apple', 'birth', 'later', 'stone', 'metal', 'chose', 'dream',
  'known', 'elite', 'maker', 'enter', 'newly', 'heavy', 'offer', 'store', 'speed', 'share',
  'strip', 'clock', 'table', 'drink', 'irony', 'quiet', 'mount', 'first', 'these', 'usage',
  'blood', 'wrong', 'suite', 'super', 'rough', 'skill', 'faith', 'funny', 'study', 'began',
  'alike', 'print', 'ought', 'undue', 'usual', 'coach', 'sharp', 'meant', 'upper', 'piece',
  'hotel', 'thick', 'paint', 'needs', 'upset', 'score', 'river', 'right', 'anger', 'dress',
  'there', 'mouth', 'debut', 'apply', 'fluid', 'lying', 'touch', 'hence', 'drawn', 'place',
  'spoke', 'check', 'unity', 'tough', 'refer', 'stake', 'trust', 'logic', 'admit', 'thank',
  'space', 'class', 'blame', 'bring', 'story', 'theft', 'acute', 'youth', 'smile', 'noise',
  'globe', 'sixth', 'tried', 'front', 'bread', 'event', 'fault', 'mouse', 'prime', 'least',
  'stuff', 'album', 'eager', 'juice', 'three', 'march', 'court', 'vital',
])

// Source: https://gist.github.com/daemondevin/df09befaf533c380743bc2c378863f0c
export const guessLibrary = new Set([
  ...
  'youth', 'zebra', 'zones', 'lazer', 'fiber', 'calif', 'input',
])
